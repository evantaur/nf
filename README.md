...
global
```
sudo sh -c 'curl -L https://raw.githubusercontent.com/evantaur/nf/dist/main/nf \
...
<pre>
python3: can't open file '/home/runner/work/nf/nf/nf': [Errno 2] No such file or directory
